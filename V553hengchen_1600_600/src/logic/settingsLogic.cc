...
static int _get_resolution_index() {
	resolution_mode_e mode = get_resolution_mode();
	switch (mode) {
		case E_RESOLUTION_MODE_1080P_1080P:
			return 0;  // 对应 "1080P"
		case E_RESOLUTION_MODE_2_5K_720P:
			return 1;  // 对应 "2.5K"
		default:
			return 0;
	}
...
static void _set_resolution_index(int index) {
  resolution_mode_e mode;
  int w = 1280, h = 720;

  switch (index) {
    case 0:  // 1080P
      mode = E_RESOLUTION_MODE_1080P_1080P;
      w = 1920;
      h = 1080;
      break;
    case 1:  // 2.5K
      mode = E_RESOLUTION_MODE_2_5K_720P;
      w = 1920;  // 2.5K实际使用1920x1080
      h = 1080;
      break;
    default:
      mode = E_RESOLUTION_MODE_1080P_1080P;
